...
Mit dieser Funktion werden jedoch **alle** existenten Datensätze importiert. Dies ist nicht unbedingt sinnvoll, da es gerade bei großen Datenbanken lange dauern und viel Speicherplatz aufbrauchen kann. 

## Queries

`idaifieldR` enthält zwei Funktionen, anhand derer eine Teilmenge aus der Datenbank abgefragt werden kann: 
